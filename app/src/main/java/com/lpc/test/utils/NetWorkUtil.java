...
public class NetWorkUtil {
    ...
    public static void openWirelessSettings() {
        if (android.os.Build.VERSION.SDK_INT > 10) {
            UIUtil.getContext().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS));
        } else {
            UIUtil.getContext().startActivity(new Intent(android.provider.Settings.ACTION_SETTINGS));
        }
    }
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager cm = (ConnectivityManager) UIUtil.getContext()
    ...
    public static boolean isAvailableByPing() {
        try {
            Process process = Runtime.getRuntime().exec("/system/bin/ping -c 1 -w 100 " + "123.125.114.144");
    ...
    public static boolean getWifiEnabled() {
        WifiManager wifiManager = (WifiManager) UIUtil.getContext().getApplicationContext()
