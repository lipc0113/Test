...
public class SkinConfig {
	...
	public 	static final String 	PREF_CUSTOM_SKIN_PATH 	= 	"com_lpc_test_custom_path";
	public  static final String 	DEFALT_SKIN 			= 	"com_lpc_test_default";
	public 	static final String 	SKIN_FROM	 			= 	"com_lpc_test_from";
