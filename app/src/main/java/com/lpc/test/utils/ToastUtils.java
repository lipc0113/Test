...
public class ToastUtils {
    ...
    private static void showToast(int resId, int duration) {
        showToast(UIUtil.getContext().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void showToast(int resId, int duration, Object... args) {
        showToast(String.format(UIUtil.getContext().getResources().getString(resId), args), duration);
    }
    ...
    private static void showToast(CharSequence text, int duration) {
        ...
        if (sToast == null) {
            sToast = Toast.makeText(UIUtil.getContext(), text, duration);
        } else {
            sToast.setText(text);
    ...
    public void showCustomToast(String str) {
        ...
        View view = LayoutInflater.from(UIUtil.getContext()).inflate(R.layout.toast_custom, null);
